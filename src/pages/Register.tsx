    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-blue-600 to-blue-800 p-12 text-white flex-col justify-center">
        <div className="max-w-md">
          ...
          <h1 className="text-4xl font-bold mb-4">Join productive teams</h1>
          <p className="text-xl text-blue-100 mb-8">
            Start organizing your projects with clean, intuitive tools designed for modern development teams.
          </p>
